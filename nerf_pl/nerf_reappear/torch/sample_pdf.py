...
def sample_pdf(bins, weights, N_importance, det=False, eps=1e-5):
    ...
    below = torch.clamp(inds - 1, 0, 1e6)
    above = torch.clamp(inds, -1e6, N_samples_)
...
#     bins=torch.linspace(0,10,10*(20+1)).view(10,-1)
#     weights=torch.linspace(0,10,10*20).view(10,-1).softmax(-1)
